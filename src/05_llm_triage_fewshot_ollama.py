...
OUTPUT_PATH = "data/processed/llm_predictions_fewshot_ollama.csv"
...
Classify the security alert into exactly one label:
- TruePositive
- FalsePositive
- BenignPositive

Important:
The alert fields are anonymized and encoded.
Use patterns from the examples below.
...
Alert:
Category: Exfiltration | MitreTechniques: unknown | EntityType: User | EvidenceRole: Impacted | DetectorId: 58 | AlertTitle: 43 | SuspicionLevel: unknown | LastVerdict: unknown | CountryCode: 242 | State: 1445 | City: 10630 | OSFamily: 5 | OSVersion: 66
Label:
FalsePositive

Alert:
Category: InitialAccess | MitreTechniques: unknown | EntityType: Ip | EvidenceRole: Related | DetectorId: 7 | AlertTitle: 6 | SuspicionLevel: unknown | LastVerdict: unknown | CountryCode: 31 | State: 6 | City: 3 | OSFamily: 5 | OSVersion: 66
Label:
TruePositive

Alert:
Category: CommandAndControl | MitreTechniques: unknown | EntityType: Url | EvidenceRole: Related | DetectorId: 2 | AlertTitle: 2 | SuspicionLevel: Suspicious | LastVerdict: Suspicious | CountryCode: 242 | State: 1445 | City: 10630 | OSFamily: 5 | OSVersion: 66
Label:
BenignPositive

Now classify the new alert.
